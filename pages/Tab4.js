...
const dataArray = [
    { title: "What is a coronavirus?", content: "Coronaviruses are a large family of viruses which may cause illness in animals or humans. In humans, several coronaviruses are known to cause respiratory infections ranging from the common cold to more severe diseases such as Middle East Respiratory Syndrome (MERS) and Severe Acute Respiratory Syndrome (SARS). The most recently discovered coronavirus causes coronavirus disease COVID-19." },
    {
    ...
    render() {
        return (
            ...
            <Content style={{ flex: 1, flexDirection: 'column', paddingHorizontal: 20 }}>
                ...
                <Heading Heading="Covid-19" Time={'Q&A'} />

                {dataArray.map((faq, key) => {
                    return (

                        <FaqCard title={faq.title} content={faq.content} num={++key} />   
                    );
                })}
